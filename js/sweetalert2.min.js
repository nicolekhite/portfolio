! function(e, t) {
  ...
  const q = {
    ...
    de = (e, t) => {
      ...
      var o = S(),
        ...
        a = E(),
        s = T();
      (t.showConfirmButton || t.showDenyButton || t.showCancelButton ? Z : J)(n), R(n, t, "actions"), pe(i, "confirm", t), pe(a, "deny", t), pe(s, "cancel", t),
        function(e, t, n, o) {
        ...
        }(i, a, s, t), t.reverseButtons && (n.insertBefore(s, o), n.insertBefore(a, o), n.insertBefore(i, o)), V(o, t.loaderHtml), R(o, t, "loader")
    };

  function pe(e, t, n) {
    $(e, n["show".concat(o(t), "Button")], "inline-block"), V(e, n["".concat(t, "ButtonText")]), e.setAttribute("aria-label", n["".concat(t, "ButtonAriaLabel")]), e.className = h[t], R(e, n, "".concat(t, "Button")), W(e, n["".concat(t, "ButtonClass")])
  }
  const me = (e, t) => {
    var n, o, i = b();
    i && (o = i, "string" == typeof(n = t.backdrop) ? o.style.background = n : n || W([document.documentElement, document.body], h["no-backdrop"]), o = i, (n = t.position) in h ? W(o, h[n]) : (s('The "position" parameter is not valid, defaulting to "center"'), W(o, h.center)), n = i, !(o = t.grow) || "string" != typeof o || (o = "grow-".concat(o)) in h && W(n, h[o]), R(i, t, "container"))
  };
  var he = {
    promise: new WeakMap,
  ...
  const Ae = (e, t) => {
      const n = k();
      R(n, t, "htmlContainer"), t.html ? (re(t.html, n), Z(n, "block")) : t.text ? (n.textContent = t.text, Z(n, "block")) : J(n), ((e, o) => {
        const i = v();
    ...
    Be = (e, t) => {
      ...
      W(e, g[t.icon]), Ee(e, t), xe(), R(e, t, "icon")
    },
    xe = () => {
      const e = v();
    ...
    Le = (e, t) => {
      e.className = "".concat(h.popup, " ").concat(G(e) ? t.showClass.popup : ""), t.toast ? (W([document.documentElement, document.body], h["toast-shown"]), W(e, h.toast)) : W(e, h.modal), R(e, t, "popup"), "string" == typeof t.customClass && W(e, t.customClass), t.icon && W(e, h["icon-".concat(t.icon)])
    },
    Oe = (e, t) => {
      var n, o, i;
      (e => {
        ...
        Z(t, ""), t.setAttribute("src", e.imageUrl), t.setAttribute("alt", e.imageAlt), Y(t, "width", e.imageWidth), Y(t, "height", e.imageHeight), t.className = h.image, R(t, e, "image")
      })(t), (e => {
        const t = C();
        $(t, e.title || e.titleText, "block"), e.title && re(e.title, t), e.titleText && (t.innerText = e.titleText), R(t, e, "title")
      })(t), (e => {
        const t = M();
        V(t, e.closeButtonHtml), R(t, e, "closeButton"), $(t, e.showCloseButton), t.setAttribute("aria-label", e.closeButtonAriaLabel)
      })(t), Ae(e, t), de(0, t), i = t, e = O(), $(e, i.footer), i.footer && re(i.footer, e), R(e, i, "footer"), "function" == typeof t.didRender && t.didRender(v())
    };
  const je = () => P() && P().click();
  const Me = e => {
      let t = v();
  ...
  const Ue = t => {
    ...
    Ke = e => Object.prototype.hasOwnProperty.call(Fe, e);
  const Ye = e => We[e],
    Ze = e => {
  ...
  var Je = Object.freeze({
    ...
    bindClickHandler: function(e = "data-swal-template") {
      Re[e] = this, Ne || (document.body.addEventListener("click", Ue), Ne = !0)
    }
  });
  ...
  function at(e, t, n, o) {
    H() ? ct(e, o) : (He(n).then(() => ct(e, o)), Ie.keydownTarget.removeEventListener("keydown", Ie.keydownHandler, {
  ...
  const rt = (e, t, n, o, i) => {
      Ie.swalCloseEventFinishedCallback = at.bind(null, e, n, o, i), t.addEventListener(ue, function(e) {
  ...
  const ht = ["swal-title", "swal-html", "swal-footer"],
    ...
    bt = e => {
      ...
      return a(e.querySelectorAll("swal-param")).forEach(e => {
        ...
        "boolean" == typeof Fe[t] && "false" === n && (n = !1), "object" == typeof Fe[t] && (n = JSON.parse(n)), o[t] = n
      }), o
    },
    ft = e => {
      const n = {};
    ...
    jt = (t, n) => {
      ...
      u(n.inputOptions) || p(n.inputOptions) ? (Me(P()), d(n.inputOptions).then(e => {
        t.hideLoading(), i(e)
    ...
    qt = (e, t) => {
      ...
      n.inputValidator ? Vt(e, o, t) : e.getInput().checkValidity() ? ("deny" === t ? Nt : Ut)(e, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage))
    },
    Vt = (t, n, o) => {
      ...
      i.then(e => {
        t.enableButtons(), t.enableInput(), e ? t.showValidationMessage(e) : ("deny" === o ? Nt : Ut)(t, n)
      })
    },
    Nt = (t, n) => {
      const e = he.innerParams.get(t || void 0);
      if (e.showLoaderOnDeny && Me(E()), e.preDeny) {
        const o = Promise.resolve().then(() => d(e.preDeny(n, e.validationMessage))).catch(e => it.swalPromiseReject.get(t || void 0)(e));
        o.then(e => {
    ...
    Ut = (t, n) => {
      ...
      if (e.showLoaderOnConfirm && Me(), e.preConfirm) {
        ...
        const o = Promise.resolve().then(() => d(e.preConfirm(n, e.validationMessage))).catch(e => it.swalPromiseReject.get(t || void 0)(e));
        o.then(e => {
          G(x()) || !1 === e ? t.hideLoading() : Rt(t, void 0 === e ? n : e)
        })
      } else Rt(t, n)
    },
    Ft = (e, t, n) => {
  ...
  const tn = (e, t, n) => {
    ...
    nn = (e, t) => {
      if (!t.toast) return c(t.allowEnterKey) ? void(on(e, t) || Ft(0, -1, 1)) : an()
    },
  ...
  e = Object.freeze({
    ...
    getInput: function(e) {
      ...
      return (e = he.domCache.get(e || this)) ? U(e.popup, t.input) : null
    },
    close: st,
    closePopup: st,
    closeModal: st,
    ...
    showValidationMessage: function(e) {
      ...
      o && (o.setAttribute("aria-invalid", !0), o.setAttribute("aria-describedby", h["validation-message"]), F(o), W(o, h.inputerror))
    },
    ...
    _main: function(e, t = {}) {
      Ze(Object.assign({}, t, e)), Ie.currentInstance && (Ie.currentInstance._destroy(), I() && ot()), Ie.currentInstance = this, mt(e = ((e, t) => {
        const n = gt(e),
          o = Object.assign({}, Fe, t, n, e);
        return o.showClass = Object.assign({}, Fe.showClass, o.showClass), o.hideClass = Object.assign({}, Fe.hideClass, o.hideClass), o
      ...
      return Oe(this, e), he.innerParams.set(this, e), s = this, r = t, c = e, new Promise((e, t) => {
        const n = e => {
          s.closePopup({
            isDismissed: !0,
            dismiss: e
        ...
        var o, i, a;
        it.swalPromiseResolve.set(s, e), it.swalPromiseReject.set(s, t), r.confirmButton.onclick = () => (e => {
          var t = he.innerParams.get(e);
          e.disableButtons(), t.input ? qt(e, "confirm") : Ut(e, !0)
        ...
        })(s, n), r.closeButton.onclick = () => n(l.close), o = s, e = r, t = n, he.innerParams.get(o).toast ? Xt(o, e, t) : (Gt(e), Qt(e), en(o, e, t)), i = s, e = Ie, t = c, a = n, e.keydownTarget && e.keydownHandlerAdded && (e.keydownTarget.removeEventListener("keydown", e.keydownHandler, {
          capture: e.keydownListenerCapture
        }), e.keydownHandlerAdded = !1), t.toast || (e.keydownHandler = e => _t(i, e, a), e.keydownTarget = t.keydownListenerCapture ? window : v(), e.keydownListenerCapture = t.keydownListenerCapture, e.keydownTarget.addEventListener("keydown", e.keydownHandler, {
          capture: e.keydownListenerCapture
        }), e.keydownHandlerAdded = !0), t = s, "select" === (e = c).input || "radio" === e.input ? jt(t, e) : ["text", "email", "number", "tel", "textarea"].includes(e.input) && (u(e.inputValue) || p(e.inputValue)) && (Me(P()), Mt(t, e)), Bt(c), tn(Ie, c, n), nn(r, c), setTimeout(() => {
    ...
    _destroy: function() {
      ...
      t && (e.popup && Ie.swalCloseEventFinishedCallback && (Ie.swalCloseEventFinishedCallback(), delete Ie.swalCloseEventFinishedCallback), Ie.deferDisposalTimer && (clearTimeout(Ie.deferDisposalTimer), delete Ie.deferDisposalTimer), "function" == typeof t.didDestroy && t.didDestroy(), delete this.params, delete Ie.keydownHandler, delete Ie.keydownTarget, sn(he), sn(it), delete Ie.currentInstance)
    }
  });
  let rn;
  class cn {
  ...
  }), cn.DismissReason = l, cn.version = "11.1.8";
  const ln = cn;
